...
SELECT 1, 'admin@gmail.com', 'Trinh Hieu', 'Phi', '$2a$10$hCYtqGLNDW9W374lnZLYq.NUOQU4NaE9HMpvaj47s1VSIbfCSyBGC', 'Admin', '2024-10-10 09:30:00', 1
    WHERE NOT EXISTS (SELECT 1 FROM users WHERE email = 'admin@gmail.com');

INSERT INTO users (id, email, firstname, lastname, password, role, date, is_verify, vip)
SELECT 2, 'phitrinh367@gmail.com', 'Hieu Phi', 'Trinh', '$2a$10$hCYtqGLNDW9W374lnZLYq.NUOQU4NaE9HMpvaj47s1VSIbfCSyBGC', 'User', '2024-10-10 09:30:00', 1, 1
